...
public class Loding
{
	...
	int  size=0;
	boolean  isOver=false;//控制加载完成后图片显示的开关
	...
	Loding()
	{
		...
		ck.setVisible(true);
		//TODO a2设置游戏快慢
		ds1 = new 定时器(80); //延时的毫秒 1000毫秒等于1秒
	}
	...
	class 窗口 extends JFrame
	{
		...
		class 面板 extends JPanel
		{
			...
			public void paint(Graphics g)
			{
				...
				{
					g.setFont(new Font("微软雅黑",Font.BOLD,24));
					g.drawString("加载"+size+"％",200,200);
				}
				if(isOver)
				{
					System.out.println(isOver);
					Image  tu=	(new ImageIcon("fox/over.jpeg")).getImage();
